...
public final class Generator implements Ast.Visitor<Void> {
    ...
    public Void visit(Ast.Source ast) {
        ...
        // This formatting may not be necessary
        // Can probably just hard code the exact statement in the project description
        print("System.exit(new Main().",
                    ast.getFunctions().getFirst().getName(),
                    "());");
        newline(--indent);
    ...
    public Void visit(Ast.Statement.If ast) {
        ...
        print("if (");
        visit(ast.getCondition());  // Visits the condition part of the if statement
        print(") {");
        newline(++indent);
        ...
        for (Ast.Statement statement : ast.getThenStatements()) {
            visit(statement);
            //print("\n");  // Ensures each statement ends with a new line
        }
        ...
        if (!ast.getElseStatements().isEmpty()) {
            print(" else {");
            newline(++indent);  // Increase indentation for the body of the else block
    ...
    public Void visit(Ast.Expression.Access ast) {
        ...
        if (ast.getOffset().isPresent()) {
            print(ast.getVariable().getJvmName(), "[", ast.getOffset().get().toString(), "]");
        } else {
